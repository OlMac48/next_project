...
2. В пункте 7.2. удалил модель которую ранее исключил из результатов работы - SVC модель  - Next commit.
3. Добавил комментарий в шапке проект со ссылкой - Next2 commit